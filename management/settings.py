...
This project implements a complete Library Management System backend
using Django REST Framework, satisfying all requirements of the
Django REST Framework Final Project evaluation guideline.
"""
